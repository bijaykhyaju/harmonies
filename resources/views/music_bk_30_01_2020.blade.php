            ...
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                        ...
                        <div class="right-element">
                          <div class="content-right">
                              ...
                              <span style="position: absolute;top: 8px;right: 20.5em;">
                                  <input class="form-control" id="bpm-value" value="{{$bitRate}}" style="width:75px;display:initial;" disabled></input>
                              </span>
                    ...
                    <div class="d-block text-center card-footer">
                        ...
                        <button class="btn-wide btn btn-success" id="" data-toggle="modal" data-target="#exampleModal">Save Music</button>
                    </div>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Do you want to save the music?</h5>
                      ...
                      if(music_name==""){
                          ...
                          //$('#music_name').focus();
                              ...
                              $.ajax({
                                url: '{{$url}}',
                                type: 'post',
                                data: {@isset($music_id) id:'{{$music_id}}', @endisset _token : CSRF_TOKEN, time: deltaTime, music_title: music_name, data : seqNoteColumnArray},
                                error: function(data) {
                                ...
                                success: function(data){
                                  ...
                                  if(data=="exist"){
                                    $('#music_name').addClass('err-class');
                                    savBtn.html("Save",500);
                                    $('.err-msg').html("Music already exist with this name. Please enter different name.");
                                    return true;
