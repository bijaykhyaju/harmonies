                ...
                r = e => {
                    ...
                    for (; a.nextNode();) {
                        ...
                        if (1 === e.nodeType) {
                            if (e.hasAttributes()) {
                                ...
                                for (; r-- > 0;) {
                                    ...
                                    this.parts.push({
                                        ...
                                        name: r,
                                        strings: a
                                    }), e.removeAttribute(s), i += a.length - 1
                                }
                            }
                            ...
                            i += a;
                            for (let t = 0; t < a; t++)
                                r.insertBefore("" === s[t] ? f() : document.createTextNode(s[t]), e), this.parts.push({
                                    type: "node",
                                    index: n++
                                });
                            ...
                            if (e.nodeValue === l) {
                                const t = e.parentNode,
                                    r = e.previousSibling;
                                null === r || r !== c || r.nodeType !== Node.TEXT_NODE ? t.insertBefore(f(), e) : n--, this.parts.push({
                                    type: "node",
                                    index: n++
                                }), o.push(e), null === e.nextSibling ? t.insertBefore(f(), e) : n--, d = c, i++
                            } else {
                                let t = -1;
                    ...
                    if (p(t))
                        if (i === t.index) {
                            if ("node" === t.type) {
                                ...
                                this._parts.push(...this.processor.handleAttributeExpressions(s, t.name, t.strings, this.options));
                            n++
                        } else
                            i++, "TEMPLATE" === s.nodeName && o(s.content), s = r.nextNode();
                    else
                        this._parts.push(void 0), n++
                }
            };
 ...
 */
    ...
    class x {
        ...
        setValue(t)
        {
            t === a || g(t) && t === this.value || (this.value = t, o(t) || (this.committer.dirty = !0))
        }
        commit()
        {
            for (; o(this.value);) {
    ...
    class _ {
        ...
        _commitTemplateResult(t)
        {
            ...
            if (this.value && this.value.template === e)
        ...
        _commitIterable(t)
        {
            ...
            let n,
                i = 0;
            for (const o of t)
                void 0 === (n = e[i]) && (n = new _(this.options), e.push(n), 0 === i ? n.appendIntoPart(this) : n.insertAfterPart(e[i - 1])), n.setValue(o), n.commit(), i++;
    ...
    class w {
        constructor(t, e, n)
        {
            if (this.value = void 0, this._pendingValue = void 0, 2 !== n.length || "" !== n[0] || "" !== n[1])
 ...
 */
    const I = new class {
        ...
        {
            const o = e[0];
            return "." === o ? new S(t, e.slice(1), n).parts : "@" === o ? [new M(t, e.slice(1), i.eventContext)] : "?" === o ? [new w(t, e.slice(1), n)] : new y(t, e, n).parts
        }
 ...
 */
    function R(t, e) {
        ...
        for (; o.nextNode();) {
            ...
            for (t.previousSibling === u && (u = null), e.has(t) && (c.push(t), null === u && (u = t)), null !== u && l++; void 0 !== s && s.index === a;)
 ...
 */
    ...
    class X extends HTMLElement {
        constructor()
        {
            super(), this._updateState = 0, this._instanceProperties = void 0, this._updatePromise = W, this._changedProperties = new Map, this._reflectingProperties = void 0, this.initialize()
        }
        ...
        static _finalize()
        {
            ...
            const e = this.properties,
                n = [...Object.getOwnPropertyNames(e), ..."function" == typeof Object.getOwnPropertySymbols ? Object.getOwnPropertySymbols(e) : []];
            for (const t of n)
        ...
        static _propertyValueFromAttribute(t, e)
        {
            ...
            if (void 0 === n)
                return t;
            const i = n === Boolean ? V : "function" == typeof n ? n : n.fromAttribute;
            return i ? i(t) : t
        }
        static _propertyValueToAttribute(t, e)
        {
            if (void 0 === e || void 0 === e.reflect)
                return;
        ...
        {
            for (const [t, e] of this._instanceProperties)
                this[t] = e;
        ...
        connectedCallback()
        {
            this._updateState & Y ? void 0 !== window.ShadyCSS && window.ShadyCSS.styleElement(this) : this.requestUpdate()
        }
        ...
        {
            return this.constructor._valueHasChanged(this[t], e, n.hasChanged) ? (this._changedProperties.has(t) || this._changedProperties.set(t, e), !0 === n.reflect && (void 0 === this._reflectingProperties && (this._reflectingProperties = new Map), this._reflectingProperties.set(t, n)), this._invalidate()) : this.updateComplete
        }
        async _invalidate()
        {
        ...
        _markUpdated()
        {
            this._changedProperties = new Map, this._updateState = this._updateState & ~K
        }
        get updateComplete()
        {
 ...
 */
    ...
    function Q(t) {
        return e => (n, i) => {Object.defineProperty(n, i, {
                get() {
 ...
 */
    class Z extends X {
        update(t)
        {
            super.update(t);
            const e = this.render();
            e instanceof m && this.constructor.render(e, this.renderRoot, {
    ...
    var i = n(3),
        ...
        l = function(t, e, n) {
            ...
            for (c in f && (n = e), n)
                h = ((u = !p && g && void 0 !== g[c]) ? g : n)[c], d = m && u ? a(h, i) : b && "function" == typeof h ? a(Function.call, h) : h, g && s(g, c, h, t & l.U), y[c] != h && r(y, c, d), b && x[c] != h && (x[c] = h)
        };
    ...
    var i = n(2),
        ...
        l = function() {
            var t,
                e = n(71)("iframe"),
                i = r.length;
            for (e.style.display = "none", n(75).appendChild(e), e.src = "javascript:", (t = e.contentWindow.document).open(), t.write("<script>document.F=Object<\/script>"), t.close(), l = t.F; i--;)
    ...
    if (n(9)) {
        var i = n(35),
            ...
            St = !!G && !!G.prototype.set && r(function() {
                new G(1).set({})
            }),
            Et = function(t, e) {
                var n = f(t);
            ...
            It = function(t, e) {
                for (var n = 0, i = e.length, o = Mt(t, i); i > n;)
                    o[n] = e[n++];
                return o
            },
            Ct = function(t, e, n) {
            ...
            Tt = function(t) {
                ...
                for (h && l > 2 && (u = c(u, arguments[2], 2)), e = 0, n = v(a.length), o = Mt(this, n); n > e; e++)
                    o[e] = h ? u(a[e], e) : a[e];
                return o
            },
            Nt = function() {
            ...
            qt = function(t, e, n) {
                return !(Dt(t, e = g(e, !0)) && _(n) && y(n, "value")) || y(n, "get") || y(n, "set") || n.configurable || y(n, "writable") && !n.writable || y(n, "enumerable") && !n.enumerable ? j(t, e, n) : (t[e] = n.value, t)
            };
        gt || (q.f = Lt, L.f = qt), s(s.S + s.F * !gt, "Object", {
        ...
        var jt = p({}, Rt);
        p(jt, zt), d(jt, ft, zt.values), p(jt, {
            slice: $t,
            set: Ft,
            constructor: function() {},
            toString: dt,
            toLocaleString: Ot
        }), Ct(jt, "buffer", "b"), Ct(jt, "byteOffset", "o"), Ct(jt, "byteLength", "l"), Ct(jt, "length", "e"), j(jt, vt, {
            get: function() {
                return this[yt]
            }
            ...
            y ? (f = n(function(t, n, i, o) {
                ...
                var r,
                    ...
                    p = 0;
                if (_(n)) {
                    if (!(n instanceof W || "ArrayBuffer" == (l = x(n)) || "SharedArrayBuffer" == l))
                        return yt in n ? It(f, n) : Tt.call(f, n);
                    r = n, p = Et(i, e);
                    var m = n.byteLength;
                    if (void 0 === o) {
                        if (m % e)
                ...
                for (d(t, "_d", {
                    ...
                    A(t, h++)
            }), S = f.prototype = E(jt), d(S, "constructor", f)) : r(function() {
                f(1)
            }) && r(function() {
                new f(-1)
            }) && $(function(t) {
                new f, new f(null), new f(1.5), new f(t)
            }, !0) || (f = n(function(t, n, i, o) {
                var r;
                return u(t, f, c), _(n) ? n instanceof W || "ArrayBuffer" == (r = x(n)) || "SharedArrayBuffer" == r ? void 0 !== o ? new m(n, Et(i, e), o) : void 0 !== i ? new m(n, Et(i, e)) : new m(n) : yt in n ? It(f, n) : Tt.call(f, n) : new m(b(n))
            }), K(g !== Function.prototype ? M(m).concat(M(g)) : M(m), function(t) {
                t in f || d(f, t, m[t])
            }), f.prototype = S, i || (S.constructor = f));
            var I = S[ft],
                C = !!I && ("values" == I.name || null == I.name),
                T = zt.values;
            d(f, bt, !0), d(S, yt, c), d(S, xt, !0), d(S, mt, f), (l ? new f(1)[vt] == c : vt in S) || j(S, vt, {
                get: function() {
                    return c
                }
            }), w[c] = f, s(s.G + s.W + s.F * (f != m), w), s(s.S, c, {
                BYTES_PER_ELEMENT: e
                ...
                from: Tt,
                of: Nt
            }), "BYTES_PER_ELEMENT" in S || d(S, "BYTES_PER_ELEMENT", e), s(s.P, c, Rt), F(c), s(s.P + s.F * St, c, {
                set: Ft
            }), s(s.P + s.F * !C, c, zt), i || S.toString == dt || (S.toString = dt), s(s.P + s.F * r(function() {
                new f(1).slice()
            }), c, {
                slice: $t
    ...
    var i = n(6)("unscopables"),
        o = Array.prototype;
    null == o[i] && n(16)(o, i, {}), t.exports = function(t) {
        o[i][t] = !0
    }
}, function(t, e, n) {
    var i = n(21),
    ...
    !function(n) {
        ...
        o.prototype.enable = function(t, e) {
            return this.enabled ? void 0 : this.supported ? void navigator.requestMIDIAccess({
                ...
                function n() {
                    clearTimeout(i), this._updateInputsAndOutputs(), this.interface.onstatechange = this._onInterfaceStateChange.bind(this), "function" == typeof t && t.call(this), o.forEach(function(t) {
                ...
                for (var s = e.inputs.values(), a = s.next(); a && !a.done; a = s.next())
                    r.push(a.value.open());
                for (var l = e.outputs.values(), c = l.next(); c && !c.done; c = l.next())
                    r.push(c.value.open());
            ...
            var e = !1;
            if (t && t.toFixed && t >= 0 && 127 >= t ? e = Math.round(t) : parseInt(t) >= 0 && parseInt(t) <= 127 ? e = parseInt(t) : ("string" == typeof t || t instanceof String) && (e = this.noteNameToNumber(t)), !1 === e)
            ...
            if (e[2].toLowerCase().indexOf("b") > -1 ? i -= e[2].length : e[2].toLowerCase().indexOf("#") > -1 && (i += e[2].length), 0 > i || i > 127)
            ...
            if (void 0 !== a.MIDI_SYSTEM_MESSAGES[t])
                this._userHandlers.system[t] || (this._userHandlers.system[t] = []), this._userHandlers.system[t].push(n);
            else {
            ...
            if (void 0 === e && (e = "all"), e.constructor !== Array && (e = [e]), void 0 !== a.MIDI_SYSTEM_MESSAGES[t]) {
                for (var o = 0; o < this._userHandlers.system[t].length; o++)
                    if (this._userHandlers.system[t][o] === n)
                        return !0
            ...
            if (void 0 === e && (e = "all"), e.constructor !== Array && (e = [e]), void 0 !== a.MIDI_SYSTEM_MESSAGES[t])
                if (void 0 === n)
                    ...
                    for (var o = 0; o < this._userHandlers.system[t].length; o++)
                        this._userHandlers.system[t][o] === n && this._userHandlers.system[t].splice(o, 1);
            else if (void 0 !== a.MIDI_CHANNEL_MESSAGES[t]) {
                if (e.indexOf("all") > -1) {
                    e = [];
                    for (var r = 1; 16 >= r; r++)
            ...
            i === a.MIDI_CHANNEL_MESSAGES.noteoff || i === a.MIDI_CHANNEL_MESSAGES.noteon && 0 === n ? (r.type = "noteoff", r.note = {
                number: e,
                name: a._notes[e % 12],
                octave: a.getOctave(e)
            }, r.velocity = n / 127, r.rawVelocity = n) : i === a.MIDI_CHANNEL_MESSAGES.noteon ? (r.type = "noteon", r.note = {
                number: e,
                name: a._notes[e % 12],
                octave: a.getOctave(e)
            }, r.velocity = n / 127, r.rawVelocity = n) : i === a.MIDI_CHANNEL_MESSAGES.keyaftertouch ? (r.type = "keyaftertouch", r.note = {
                number: e,
                name: a._notes[e % 12],
                octave: a.getOctave(e)
            }, r.value = n / 127) : i === a.MIDI_CHANNEL_MESSAGES.controlchange && e >= 0 && 119 >= e ? (r.type = "controlchange", r.controller = {
                number: e,
                name: this.getCcNameByNumber(e)
            }, r.value = n) : i === a.MIDI_CHANNEL_MESSAGES.channelmode && e >= 120 && 127 >= e ? (r.type = "channelmode", r.controller = {
                number: e,
                name: this.getChannelModeByNumber(e)
            }, r.value = n) : i === a.MIDI_CHANNEL_MESSAGES.programchange ? (r.type = "programchange", r.value = e) : i === a.MIDI_CHANNEL_MESSAGES.channelaftertouch ? (r.type = "channelaftertouch", r.value = e / 127) : i === a.MIDI_CHANNEL_MESSAGES.pitchbend ? (r.type = "pitchbend", r.value = ((n << 7) + e - 8192) / 8192) : r.type = "unknownchannelmessage", this._userHandlers.channel[r.type] && this._userHandlers.channel[r.type][o] && this._userHandlers.channel[r.type][o].forEach(function(t) {
                t(r)
            })
            ...
            for (var e in a.MIDI_CONTROL_CHANGE_MESSAGES)
                if (a.MIDI_CONTROL_CHANGE_MESSAGES.hasOwnProperty(e) && t === a.MIDI_CONTROL_CHANGE_MESSAGES[e])
                    return e
            ...
            for (var e in a.MIDI_CHANNEL_MODE_MESSAGES)
                if (a.MIDI_CHANNEL_MODE_MESSAGES.hasOwnProperty(e) && t === a.MIDI_CHANNEL_MODE_MESSAGES[e])
                    return e
            ...
            if ((n = n || {}).rawVelocity ? !isNaN(n.velocity) && n.velocity >= 0 && n.velocity <= 127 && (i = n.velocity) : !isNaN(n.velocity) && n.velocity >= 0 && n.velocity <= 1 && (i = 127 * n.velocity), n.time = this._parseTimeParameter(n.time), this._convertNoteToArray(t).forEach(function(t) {
                ...
                var o = 64;
                n.rawVelocity ? !isNaN(n.release) && n.release >= 0 && n.release <= 127 && (o = n.release) : !isNaN(n.release) && n.release >= 0 && n.release <= 1 && (o = 127 * n.release), this._convertNoteToArray(t).forEach(function(t) {
                    a.toMIDIChannels(e).forEach(function(e) {
                        this.send((a.MIDI_CHANNEL_MESSAGES.noteoff << 4) + (e - 1), [t, Math.round(o)], (n.time || a.time) + n.duration)
                    }.bind(this))
                }.bind(this))
            }
            return this
            ...
            return this._convertNoteToArray(t).forEach(function(t) {
                a.toMIDIChannels(e).forEach(function(e) {
                    o.send((a.MIDI_CHANNEL_MESSAGES.keyaftertouch << 4) + (e - 1), [t, r], o._parseTimeParameter(i.time))
                })
            }), this
            ...
            return a.toMIDIChannels(e).forEach(function(o) {
            ...
            var i = this;
            if ((t = [].concat(t))[0] = Math.floor(t[0]), !(t[0] >= 0 && t[0] <= 127))
                throw new RangeError("The msb value must be between 0 and 127");
            return a.toMIDIChannels(e).forEach(function(o) {
                i.sendControlChange(6, t[0], e, {
                    time: n
                })
            }), t[1] = Math.floor(t[1]), t[1] >= 0 && t[1] <= 127 && a.toMIDIChannels(e).forEach(function(o) {
            ...
            return a.toMIDIChannels(n).forEach(function(r) {
                o._selectRegisteredParameter(t, n, i.time), o._setCurrentRegisteredParameter(e, n, i.time), o._deselectRegisteredParameter(n, i.time)
            }), this
        }, s.prototype.setNonRegisteredParameter = function(t, e, n, i) {
            var o = this;
            if (i = i || {}, !(t[0] >= 0 && t[0] <= 127 && t[1] >= 0 && t[1] <= 127))
                throw new Error("Position 0 and 1 of the 2-position parameter array must both be between 0 and 127.");
            return e = [].concat(e), a.toMIDIChannels(n).forEach(function(r) {
                o._selectNonRegisteredParameter(t, n, i.time), o._setCurrentRegisteredParameter(e, n, i.time), o._deselectRegisteredParameter(n, i.time)
            }), this
            ...
            var i = this;
            if (n = n || {}, t = Math.floor(t), isNaN(t) || 0 > t || t > 127)
            ...
            return a.toMIDIChannels(e).forEach(function(t) {
                i.send((a.MIDI_CHANNEL_MESSAGES.channelaftertouch << 4) + (t - 1), [o], i._parseTimeParameter(n.time))
            }), this
            ...
            var o = Math.round((t + 1) / 2 * 16383),
                ...
                s = 127 & o;
            return a.toMIDIChannels(e).forEach(function(t) {
                i.send((a.MIDI_CHANNEL_MESSAGES.pitchbend << 4) + (t - 1), [s, r], i._parseTimeParameter(n.time))
            }), this
    ...
    class o extends i.a {
        ...
        constructor()
        {
            super(), this.min = -1.1, this.max = 1.1, this.buffer = new Float32Array(100), this.color = "black"
        }
    ...
    t.exports = function(t, e, n, f, v, b, m) {
        ...
        if (C && (x = u(C.call(new t))) !== Object.prototype && x.next && (c(x, w, !0), i || "function" == typeof x[h] || s(x, h, p)), S && M && "values" !== M.name && (E = !0, A = function() {
            return M.call(this)
        }), i && !m || !d && !E && k[h] || s(k, h, A), a[e] = A, a[w] = p, v)
            if (g = {
                values: S ? A : _("values"),
                keys: b ? A : _("keys"),
                entries: I
    ...
    t.exports = function(t, e, n, v, b, m) {
        ...
        if ("function" == typeof y && (m || _.forEach && !h(function() {
            ...
            })).prototype = _, _.constructor = y), (M || I) && (S("delete"), S("has"), b && S("get")), (I || k) && S(x), m && _.clear && delete _.clear
        } else
            y = v.getConstructor(e, t, b, x), s(y.prototype, n), a.NEED = !0;
        return p(y, t), w[t] = y, o(o.G + o.W + o.F * (y != g), w), m || v.setStrong(y, t, b), y
    }
}, function(t, e, n) {
    for (var i, o = n(3), r = n(16), s = n(39), a = s("typed_array"), l = s("view"), c = !(!o.ArrayBuffer || !o.DataView), u = c, h = 0, d = "Int8Array,Uint8Array,Uint8ClampedArray,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array".split(","); h < 9;)
        (i = o[d[h++]]) ? (r(i.prototype, a, !0), r(i.prototype, l, !0)) : u = !1;
    t.exports = {
        ABV: c,
        CONSTR: u,
        TYPED: a,
    ...
    t.exports = !l || n(5)(function() {
        ...
        for (var n = s(t), l = arguments.length, c = 1, u = o.f, h = r.f; l > c;)
            for (var d, p = a(arguments[c++]), f = u ? i(p).concat(u(p)) : i(p), v = f.length, b = 0; v > b;)
    ...
    var i = n(11),
        ...
        r = n(10);
    t.exports = function(t) {
        for (var e = i(this), n = r(e.length), s = arguments.length, a = o(s > 1 ? arguments[1] : void 0, n), l = s > 2 ? arguments[2] : void 0, c = void 0 === l ? n : o(l, n); c > a;)
            e[a++] = t;
        return e
    }
}, function(t, e, n) {
    ...
    d && p || (d = function(t) {
        ...
        delete m[t]
    }, "process" == n(22)(h) ? i = function(t) {
        h.nextTick(s(g, t, 1))
    } : v && v.now ? i = function(t) {
        v.now(s(g, t, 1))
    } : f ? (r = (o = new f).port2, o.port1.onmessage = y, i = s(r.postMessage, r, 1)) : u.addEventListener && "function" == typeof postMessage && !u.importScripts ? (i = function(t) {
        u.postMessage(t + "", "*")
    ...
    function R(t, e, n) {
        var i,
            ...
            h = 0,
            d = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
        for ((t = M(t)) != t || t === E ? (o = t != t ? 1 : 0, i = l) : (i = I(C(t) / T), t * (r = A(2, -i)) < 1 && (i--, r *= 2), (t += i + c >= 1 ? u / r : u * A(2, 1 - c)) * r >= 2 && (i++, r /= 2), i + c >= l ? (o = 0, i = l) : i + c >= 1 ? (o = (t * r - 1) * A(2, e), i += c) : (o = t * A(2, c - 1) * A(2, e), i = 0)); e >= 8; s[h++] = 255 & o, o /= 256, e -= 8)
            ;
    ...
    if (s.ABV) {
        if (!c(function() {
            ...
            for (var G, U = (x = function(t) {
                    return u(this, x), new k(p(t))
                })[g] = k[g], W = f(k), Y = 0; W.length > Y;)
                (G = W[Y++]) in x || a(x, G, k[G]);
            r || (U.constructor = x)
        }
        var K = new _(new x(2)),
            J = _[g].setInt8;
        K.setInt8(0, 2147483648), K.setInt8(1, 2147483649), !K.getInt8(0) && K.getInt8(1) || l(_[g], {
        ...
        }, o && (H(x, "byteLength", "_l"), H(_, "buffer", "_b"), H(_, "byteLength", "_l"), H(_, "byteOffset", "_o")), l(_[g], {
            getInt8: function(t) {
    ...
    t.exports = [].copyWithin || function(t, e) {
        var n = i(this),
            ...
            h = 1;
        for (l < a && a < l + u && (h = -1, l += u - 1, a += u - 1); u-- > 0;)
    ...
    t.exports = {
        getConstructor: function(t, e, n, c) {
            var u = t(function(t, i) {
                a(t, u, e, "_i"), t._t = e, t._i = o(null), t._f = void 0, t._l = void 0, t[v] = 0, null != i && l(i, n, t[c], t)
            });
    ...
    var i,
        ...
        m = {
            get: function(t) {
                if (c(t)) {
                    var e = d(t);
                    return !0 === e ? f(h(this, "WeakMap")).get(t) : e ? e[this._i] : void 0
                }
            },
            set: function(t, e) {
    ...
    }) && (a((i = l.getConstructor(b, "WeakMap")).prototype, m), s.NEED = !0, o(["delete", "has", "get", "set"], function(t) {
        var e = g.prototype,
            n = e[t];
        r(e, t, function(e, o) {
            if (c(e) && !p(e)) {
    ...
    b.prototype = {
        ...
        getConstructor: function(t, e, n, r) {
            var c = t(function(t, i) {
                a(t, c, e, "_i"), t._t = e, t._i = f++, t._l = void 0, null != i && l(i, n, t[r], t)
            });
    ...
    t.exports = function t(e, n, l, c, u, h, d, p) {
        for (var f, v, b = u, m = 0, g = !!d && s(d, p, 3); m < c;) {
            if (m in l) {
                if (f = g ? g(l[m], m, n) : l[m], v = !1, o(f) && (v = void 0 !== (v = f[a]) ? !!v : i(f)), v && h > 0)
    ...
    var i = n(132),
        ...
        r = n(12);
    t.exports = function() {
        for (var t = r(this), e = arguments.length, n = new Array(e), s = 0, a = i._, l = !1; e > s;)
    ...
    t.exports = function(t) {
        ...
        Object.defineProperty(e, "__esModule", {
            ...
            if ((0, o.isObject)(e) && (0, o.isObject)(l))
                for (var c in l)
                    (0, o.isObject)(l[c]) ? (e[c] || Object.assign(e, i({}, c, {})), t(e[c], l[c])) : (0, r.isArray)(l[c]) ? (e[c] || Object.assign(e, i({}, c, [])), e[c] = e[c].concat(l[c])) : Object.assign(e, i({}, c, l[c]));
    ...
    !function(o) {
        ...
        function d(t, e) {
            ...
            var n = function(t) {
                ...
                "object" == typeof t && (B(t.r) && B(t.g) && B(t.b) ? (p = t.r, f = t.g, v = t.b, e = {
                    r: 255 * O(p, 255),
                    g: 255 * O(f, 255),
                    b: 255 * O(v, 255)
                }, h = !0, d = "%" === String(t.r).substr(-1) ? "prgb" : "rgb") : B(t.h) && B(t.s) && B(t.v) ? (i = z(t.s), a = z(t.v), e = function(t, e, n) {
        ...
        function v(t, e, n, i) {
            var o = [F(l(t).toString(16)), F(l(e).toString(16)), F(l(n).toString(16))];
        ...
        function b(t, e, n, i) {
            return [F(D(i)), F(l(t).toString(16)), F(l(e).toString(16)), F(l(n).toString(16))].join("")
        }
        function m(t, e) {
            e = 0 === e ? 0 : e || 10;
            var n = d(t).toHsl();
        ...
        function _(t, e) {
            e = 0 === e ? 0 : e || 10;
            var n = d(t).toRgb();
            return n.r = u(0, c(255, n.r - l(-e / 100 * 255))), n.g = u(0, c(255, n.g - l(-e / 100 * 255))), n.b = u(0, c(255, n.b - l(-e / 100 * 255))), d(n)
        }
        function w(t, e) {
            e = 0 === e ? 0 : e || 10;
            var n = d(t).toHsl();
        ...
        function C(t, e) {
            e = e || 6;
            for (var n = d(t).toHsv(), i = n.h, o = n.s, r = n.v, s = [], a = 1 / e; e--;)
                s.push(d({
                    h: i,
                    s: o,
                    v: r
        ...
        d.prototype = {
            ...
            getLuminance: function() {
                var t,
                    ...
                    n,
                    i = this.toRgb();
                return t = i.r / 255, e = i.g / 255, n = i.b / 255, .2126 * (t <= .03928 ? t / 12.92 : o.pow((t + .055) / 1.055, 2.4)) + .7152 * (e <= .03928 ? e / 12.92 : o.pow((e + .055) / 1.055, 2.4)) + .0722 * (n <= .03928 ? n / 12.92 : o.pow((n + .055) / 1.055, 2.4))
            },
            setAlpha: function(t) {
            ...
            toHex8: function(t) {
                return function(t, e, n, i, o) {
                    var r = [F(l(t).toString(16)), F(l(e).toString(16)), F(l(n).toString(16)), F(D(i))];
                    if (o && r[0].charAt(0) == r[0].charAt(1) && r[1].charAt(0) == r[1].charAt(1) && r[2].charAt(0) == r[2].charAt(1) && r[3].charAt(0) == r[3].charAt(1))
            ...
            toName: function() {
                return 0 === this._a ? "transparent" : !(this._a < 1) && (N[v(this._r, this._g, this._b, !0)] || !1)
            },
            toFilter: function(t) {
            ...
            return d.isReadable(t, a, {
                level: r,
                size: s
            }) || !o ? a : (n.includeFallbackColors = !1, d.mostReadable(t, ["#fff", "#000"], n))
        };
        var T = d.names = {
                aliceblue: "f0f8ff",
                antiquewhite: "faebd7",
        ...
        var q,
            j,
            H,
            V = (j = "[\\s|\\(]+(" + (q = "(?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?)") + ")[,|\\s]+(" + q + ")[,|\\s]+(" + q + ")\\s*\\)?", H = "[\\s|\\(]+(" + q + ")[,|\\s]+(" + q + ")[,|\\s]+(" + q + ")[,|\\s]+(" + q + ")\\s*\\)?", {
    ...
    var i = n(3),
        ...
        B = r && c(function() {
            ...
            var i = I(q, e);
            i && delete q[e], C(t, e, n), i && t !== q && C(q, e, i)
        } : C,
        G = function(t) {
            var e = D[t] = S(N.prototype);
            return e._k = t, e
        },
        U = j && "symbol" == typeof N.iterator ? function(t) {
            return "symbol" == typeof t
        } : function(t) {
            return t instanceof N
        },
        W = function(t, e, n) {
            return t === q && W(L, e, n), g(t), e = _(e, !0), g(n), o(D, e) ? (n.enumerable ? (o(t, R) && t[R][e] && (t[R][e] = !1), n = S(n, {
                enumerable: w(0, !1)
            })) : (o(t, R) || C(t, R, w(1, {})), t[R][e] = !0), B(t, e, n)) : C(t, e, n)
        },
        Y = function(t, e) {
            g(t);
        ...
        K = function(t) {
            ...
            return !(this === q && o(D, t) && !o(L, t)) && (!(e || !o(this, t) || !o(D, t) || o(this, R) && this[R][t]) || e)
        },
        J = function(t, e) {
        ...
        X = function(t) {
            for (var e, n = T(x(t)), i = [], r = 0; n.length > r;)
                o(D, e = n[r++]) || e == R || e == l || i.push(e);
            return i
        },
        Q = function(t) {
            for (var e, n = t === q, i = T(n ? L : x(t)), r = [], s = 0; i.length > s;)
    ...
    j || (a((N = function() {
        ...
        var t = d(arguments.length > 0 ? arguments[0] : void 0),
            e = function(n) {
                this === q && e.call(L, n), o(this, R) && o(this[R], t) && (this[R][t] = !1), B(this, t, w(1, n))
            };
        return r && V && B(q, t, {
            configurable: !0,
            set: e
        ...
        return this._k
    }), k.f = J, M.f = W, n(41).f = E.f = X, n(52).f = K, n(56).f = Q, r && !n(35) && a(q, "propertyIsEnumerable", K, !0), f.f = function(t) {
        return G(p(t))
    }), s(s.G + s.W + s.F * !j, {
        Symbol: N
    });
    ...
    }), N.prototype[$] || n(16)(N.prototype, $, N.prototype.valueOf), h(N, "Symbol"), h(Math, "Math", !0), h(i.JSON, "JSON", !0)
}, function(t, e, n) {
    var i = n(29),
        o = n(56),
        r = n(52);
    ...
    var i = n(42),
        o = {};
    o[n(6)("toStringTag")] = "z", o + "" != "[object z]" && n(17)(Object.prototype, "toString", function() {
    ...
    if (!p(" 0o1") || !p("0b1") || p("+0x1")) {
        p = function(t) {
            ...
            return n instanceof p && (b ? l(function() {
                v.valueOf.call(n)
            }) : "Number" != r(n)) ? s(new f(g(e)), n, p) : g(e)
        };
        for (var y, x = n(9) ? c(f) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger".split(","), _ = 0; x.length > _; _++)
    ...
    i(i.S, "Math", {
        hypot: function(t, e) {
            for (var n, i, r = 0, s = 0, a = arguments.length, l = 0; s < a;)
                l < (n = o(arguments[s++])) ? (r = r * (i = l / n) * i + 1, l = n) : r += n > 0 ? (i = n / l) * i : n;
    ...
    i(i.P + i.F * n(5)(function() {
        ...
        slice: function(t, e) {
            ...
            for (var o = s(t, n), c = s(e, n), u = a(c - o), h = new Array(u), d = 0; d < u; d++)
    ...
    n(63)("split", 2, function(t, e, i) {
        ...
        if ("c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length) {
            ...
            i = function(t, e) {
                ...
                for (a || (i = new RegExp("^" + b.source + "$(?!\\s)", p)); (l = b.exec(n)) && !((c = l.index + l[0].length) > f && (d.push(n.slice(f, l.index)), !a && l.length > 1 && l[0].replace(i, function() {
                    for (h = 1; h < arguments.length - 2; h++)
                        void 0 === arguments[h] && (l[h] = void 0)
                }), l.length > 1 && l.index < n.length && s.apply(d, l.slice(1)), u = l[0].length, f = c, d.length >= v));)
    ...
    var i,
        ...
        N = !!function() {
            try {
                ...
                return (I || "function" == typeof PromiseRejectionEvent) && t.then(C) instanceof e && 0 !== M.indexOf("6.6") && -1 === _.indexOf("Chrome/66")
            } catch (t) {}
        }(),
        P = function(t) {
            var e;
                ...
                g(function() {
                    for (var i = t._v, o = 1 == t._s, r = 0, s = function(e) {
                            var n,
                                ...
                                u = e.domain;
                            try {
                                a ? (o || (2 == t._h && F(t), t._h = 1), !0 === a ? n = i : (u && u.enter(), n = a(i), u && (u.exit(), s = !0)), n === e.promise ? c(S("Promise-chain cycle")) : (r = P(n)) ? r.call(n, l, c) : l(n)) : c(i)
                            } catch (t) {
                                u && !s && u.exit(), c(t)
                            }
                        }; n.length > r;)
        ...
        R = function(t) {
            m.call(l, function() {
                ...
                }), t._h = I || $(t) ? 2 : 1), t._a = void 0, r && e.e)
                    throw e.v
            })
        },
        $ = function(t) {
    ...
    N || (A = function(t) {
        ...
        then: function(t, e) {
            var n = T(b(this, A));
            return n.ok = "function" != typeof t || t, n.fail = "function" == typeof e && e, n.domain = I ? E.domain : void 0, this._c.push(n), this._a && this._a.push(n), this._s && O(this, !1), n.promise
        },
        catch: function(t) {
        ...
        Promise: A
    }), n(47)(A, "Promise"), n(44)("Promise"), s = n(13).Promise, h(h.S + h.F * !N, "Promise", {
        reject: function(t) {
            var e = T(this);
    ...
    i(i.G + i.W + i.F * (u !== d), {
        ...
        slice: function(t, e) {
            ...
            for (var n = s(this).byteLength, i = a(t, n), o = a(void 0 === e ? n : e, n), r = new (h(this, d))(l(o - i)), c = new p(this), u = new p(r), f = 0; i < o;)
    ...
    i(i.S, "Object", {
        getOwnPropertyDescriptors: function(t) {
            for (var e, n, i = r(t), l = s.f, c = o(i), u = {}, h = 0; c.length > h;)
    ...
    for (var i = n(91), o = n(29), r = n(17), s = n(3), a = n(16), l = n(43), c = n(6), u = c("iterator"), h = c("toStringTag"), d = l.Array, p = {
            CSSRuleList: !0,
    ...
    function k(t) {
        var e = a(null);
        return null != t && (f(t) ? p(t, !0, function(t, n) {
            e[t] = n
        }) : s(e, t)), e
    }
    v(E, "Dict", function() {
        ...
        reduce: function(t, e, n) {
            ...
            if (arguments.length < 3) {
                ...
                i = Object(n);
            for (; a > l;)
                x(r, o = s[l++]) && (i = e(i, r[o], o, t));
            return i
        },
        keyOf: h,
        includes: function(t, e) {
            return void 0 !== (e == e ? h(t, e) : w(t, function(t) {
                return t != t
            }))
        },
        has: x,
    ...
    var i = n(132),
        o = n(1);
    n(13)._ = i._ = i._ || {}, o(o.P + o.F, "Function", {
        part: n(131)
    })
}, function(t, e, n) {
    var i = n(1);
        ...
        for (var n = 0; n < t.length; n++) {
            ...
            if (o) {
                ...
                for (; s < i.parts.length; s++)
                    o.parts.push(g(i.parts[s], e))
            } else {
                var a = [];
                for (s = 0; s < i.parts.length; s++)
                    a.push(g(i.parts[s], e));
                r[i.id] = {
                    id: i.id,
                    refs: 1,
                    parts: a
    ...
    function f(t, e) {
        ...
        var i = u[u.length - 1];
        if ("top" === t.insertAt)
            i ? i.nextSibling ? n.insertBefore(e, i.nextSibling) : n.appendChild(e) : n.insertBefore(e, n.firstChild), u.push(e);
    ...
    (function(t) {
        ...
        customElements.define("tone-viz-oscillator", class  extends e.a{
            constructor()
            {
                super(), this.min = -1.1, this.max = 1.1, this.alt = "oscillator waveform"
            }
            async visualize(e)
            {
                const n = e.get(),
    ...
    t.exports = {
        _setState: function(t) {
            t || (t = {}), this._state = {}, this._extendState({
                polyphony: 4,
                rows: 1,
                priority: "last",
                rootNote: 60,
        ...
        set: function() {
            return 1 === arguments.length ? this._extendState(arguments[0]) : this._state[arguments[0]] = arguments[1], this
        },
        get: function(t) {
    ...
    t.exports = {
        ...
        _trigger: function(t) {
            ...
            if (e._listeners[t] && e._listeners[t].length) {
                ...
                n.splice(0, 1), e._listeners[t].forEach(function(t) {
                    t.apply(e, n)
                })
            }
        },
    ...
    t.exports = {
        _addKey: function(t) {
            if (this._isNote(t.keyCode) && !this._isPressed(t.keyCode)) {
                ...
                this._isSpecialKey(t.keyCode) && this._specialKey(t.keyCode)
        },
        ...
        _isPressed: function(t) {
            if (!this._state.keys || !this._state.keys.length)
                return !1;
            for (var e = 0; e < this._state.keys.length; e++)
                if (this._state.keys[e].keyCode === t)
                    return !0;
            return !1
        },
    ...
    t.exports = {
        _prioritize: function() {
            var t = this;
            t._state.keys.length ? (t._state.polyphony >= t._state.keys.length ? t._state.keys = t._state.keys.map(function(t) {
                return t.isActive = !0, t
            }) : (t._state.keys = t._state.keys.map(function(t) {
                return t.isActive = !1, t
            }), t["_" + t._state.priority]()), t._state.buffer = [], t._state.keys.forEach(function(e) {
                e.isActive && t._state.buffer.push(e)
            })) : t._state.buffer = []
        },
        _last: function() {
            for (var t = this._state.keys.length - this._state.polyphony; t < this._state.keys.length; t++)
        ...
        _highest: function() {
            ...
            }), t.splice(this._state.polyphony, Number.MAX_VALUE), this._state.keys.forEach(function(e) {
    ...
    t.exports = {
        ...
        _specialKey: function(t) {
            "octave" === this._specialKeyMap[t].type && this._state.octaveControls ? this._state.octave += this._specialKeyMap[t].value : "velocity" === this._specialKeyMap[t].type && this._state.velocityControls && (this._state.velocity = this._specialKeyMap[t].value)
        },
        _specialKeyMap: {
            90: {
                type: "octave",
    ...
    t.exports = {
        ...
        _shasum: "5aca69390d9affe5a612152b5f0843ae399ac597",
        _spec: "nested-object-assign",
        _where: "/Users/ymann/Development/third-party/tonejs-ui",
        author: {
    ...
    }, o.resolve = r, t.exports = o, o.id = 365
}, function(t, e, n) {
    "use strict";
    n.r(e);
    n(352);
    ...
    function u(t, e, n, i, o, u) {
        ...
        if (0 == e && 0 == o && (p = function(t, e, n) {
            ...
            for (; r < n && h(t[--i], e[--o]);)
                r++;
            return r
        }(t, i, v - p)), o += p, u -= f, (n -= f) - (e += p) == 0 && u - o == 0)
            return [];
        if (e == n) {
            for (d = r(e, [], 0); o < u;)
                d.removed.push(i[o++]);
        ...
        let b = function(t) {
            ...
            let s = r - o + 1,
                ...
                l = new Array(s);
            for (let t = 0; t < s; t++)
                l[t] = new Array(a), l[t][0] = t;
            for (let t = 0; t < a; t++)
                l[0][t] = t;
            for (let n = 1; n < s; n++)
                for (let r = 1; r < a; r++)
                    if (h(t[e + r - 1], i[o + n - 1]))
                        l[n][r] = l[n - 1][r - 1];
                    else {
                        let t = l[n - 1][r] + 1,
                            e = l[n][r - 1] + 1;
...
*/
    ...
    class y {
        ...
        {
            return g(t) ? (t = t).assignedNodes({
                flatten: !0
            }) : Array.from(t.childNodes).map(t => g(t) ? (t = t).assignedNodes({
                flatten: !0
            }) : [t]).reduce((t, e) => t.concat(e), [])
        }
        constructor(t, e)
        {
            this._shadyChildrenObserver = null, this._nativeChildrenObserver = null, this._connected = !1, this._target = t, this.callback = e, this._effectiveNodes = [], this._observer = null, this._scheduled = !1, this._boundSchedule = (() => {this._schedule()}), this.connect(), this._schedule()
        }
        connect()
        {
            g(this._target) ? this._listenSlots([this._target]) : this._target.children && (this._listenSlots(this._target.children), window.ShadyDOM ? this._shadyChildrenObserver = ShadyDOM.observeChildren(this._target, t => {this._processMutations(t)}) : (this._nativeChildrenObserver = new MutationObserver(t => {this._processMutations(t)}), this._nativeChildrenObserver.observe(this._target, {
                childList: !0
            }))), this._connected = !0
        }
        disconnect()
    ...
    class _ extends i.a {
        ...
        constructor()
        {
            super(), this.selectedIndex = -1, this.options = [], this._observer = new y(this, t => {this.options = [...this.options, ...t.addedNodes.filter(t => "option" === t.nodeName.toLowerCase())], this.options.length && -1 === this.selectedIndex && (this.selectedIndex = 0), this.requestUpdate()})
        }
        updated(t)
        {
            if (t.has("selectedIndex") && -1 !== this.selectedIndex) {
                ...
                this.dispatchEvent(new CustomEvent("change", {
                    ...
                    composed: !0,
                    bubbles: !0
                })), t && (t.selectedIndex = this.selectedIndex), this.attribute && this.dispatchEvent(new CustomEvent(this.attribute, {
                    detail: this.value,
                    composed: !0,
                    bubbles: !0
                }))
        ...
        set value(t)
        {
            const e = this.options.findIndex(e => e.getAttribute("value") === t.toString());
        ...
        render()
        {
            ...
            t => this.selectedIndex = t.target.selectedIndex}>
					${
            this.options}
				</select>
				<div id="arrow">${
    ...
    customElements.define("tone-oscillator-type", class  extends i.a{
        ...
        {
            return i.b`
			<tone-select-attribute label=${
            this.label} attribute=${this.attribute}>
    ...
    customElements.define("tone-oscillator", class  extends o.a{
        ...
        setAttribute(t, e, n)
        {
            "type" === t ? "oscillator" === this.sourceType ? n.type = e.value : "am" === this.sourceType || "fat" === this.sourceType || "fm" === this.sourceType ? n.type = `${this.sourceType}${e.value}` : n.type = e.value : e.set(n)
        }
        updated(t)
        {
            t.has("sourceType") && this.dispatchEvent(new CustomEvent("sourceType", {
        ...
        renderAttributes()
        {
            ...
            "pulse" !== this.sourceType && "pwm" !== this.sourceType}
					label="${
            "fm" === this.sourceType || "am" === this.sourceType ? "Carrier Type" : "Type"}"
					attribute="baseType">
				</tone-oscillator-type>
				<tone-multislider
					?display=${
    ...
    customElements.define("tone-rack", class  extends i.a{
        static get properties()
        {
            return {
                collapsed: {
        ...
        constructor()
        {
            super(), this.incollapsable = !1, this.collapsed = !1, this.square = !1
        }
        updated(t)
        {
            const e = t => {t.dispatchEvent(new CustomEvent("collapse", {
                    detail: this.collapsed,
                    composed: !0,
                    bubbles: !0
                }))};
            t.has("collapsed") && (e(this), Array.from(this.children).forEach(t => {t.assignedNodes ? Array.from(t.assignedNodes()).forEach(t => e(t)) : e(t), t.dispatchEvent(new CustomEvent("collapse", {
                    detail: this.collapsed,
                    composed: !0,
                    bubbles: !0
                }))}))
        ...
        _keydown(t)
        {
            "ArrowRight" === t.key || "ArrowDown" === t.key ? this.collapsed = !1 : "ArrowLeft" !== t.key && "ArrowUp" !== t.key || (this.collapsed = !0)
        }
        render()
        {
            return i.b`
            ...
            this.collapsed ? "closed" : "open"} ?square=${this.square}>
				${
            ...
            this.collapsed}">${this.collapsed ? w : S}</button>`}
				<h2 id="label">${
            this.label}</h2>
				<div id="padding"></div>
				<slot name="top"></slot>
    ...
    customElements.define("tone-toggle", class  extends i.a{
        ...
        updated(t)
        {
            t.has("checked") && (this.dispatchEvent(new CustomEvent("change", {
                detail: this.checked,
                composed: !0,
                bubbles: !0
            })), this.attribute && this.dispatchEvent(new CustomEvent(this.attribute, {
                detail: this.checked,
                composed: !0,
                bubbles: !0
            })))
        ...
        _clicked(t)
        {
            t.stopPropagation(), this.checked = !this.checked, this.shadowRoot.querySelector("button").focus()
        }
        render()
        {
            return i.b`
    ...
    async function k(t) {
        if ("suspended" === Tone.context.state) {
            ...
            n.controls = !1, n.preload = "auto", n.loop = !1, n.src = E, n.title = "Tone.js Examples";
    ...
    customElements.define("tone-play-toggle", class  extends i.a{
        static get properties()
        {
            return {
                playing: {
        ...
        updated(t)
        {
            t.has("playing") && (this.dispatchEvent(new CustomEvent("change", {
                detail: this.playing,
                composed: !0,
                bubbles: !0
        ...
        bind(t)
        {
            this.addEventListener("change", e => {e.detail ? t.start() : t.stop()}), setInterval(() => {"stopped" === t.state && (this.playing = !1)}, 100)
        }
        async _clicked(t)
        {
    ...
    var I = n(137),
        C = n.n(I);
    customElements.define("tone-player-viz", class  extends i.a{
        static get properties()
        {
            return {
                color: {
        ...
        _computeRMS(t, e)
        {
            if (this._waveform && this._waveform.length === e)
                return;
            const n = t.toArray(0),
                i = [];
            for (let t = 0; t < e; t++) {
            ...
            const o = Math.max(...i);
            this._waveform = i.map(t => Math.scale(Math.pow(t, .8), 0, o, 0, 1))
        }
        visualize(t)
        {
            if (this.loading = !t.loaded, t.loaded) {
                ...
                const l = C()(this.color).setAlpha(.2).toRgbString();
                this._waveform.forEach((e, n) => {
                    const c = e * o,
                        u = t.reverse ? i - n : n;
                    t.loop && (r.fillStyle = s > u || u > a ? l : this.color), r.fillRect(u, o / 2 - c / 2, 1, c), r.fill()
                })
            }
        }
        render()
        {
            ...
            !this.loading} style="color: ${this.color}">loading</div>
		`
        }
    }
    );
    customElements.define("tone-player", class  extends o.a{
        ...
        bind(t)
        {
            const e = setInterval(() => {t.loaded && (clearInterval(e), this.duration = t.buffer.duration, this.sync(t))}, 100);
            super.bind(t)
        }
        render()
        {
            ...
            t => this.collapsed = t.detail}
				?collapsed=${
            this.collapsed} label="${this.label}">
    ...
    var T = n(99),
        N = n.n(T);
    customElements.define("tone-slider", class  extends i.a{
        static get properties()
        {
            return {
                min: {
        ...
        constructor()
        {
            super(), this.min = 0, this.max = 100, this.step = 1, this.value = 50, this.exp = 1, this.anchor = "left", this.integer = !1, this.bare = !1, this._setThrottle = -1
        }
        _logValue(t)
        {
            ...
            this.integer && (o = Math.round(o)), this.value = o, this.dispatchEvent(new CustomEvent("input", {
                composed: !0,
                detail: this.value
            }))
        }
        ...
        _logPosition()
        {
            const t = Math.scale(this.value, this.min, this.max, Math.pow(1, this.exp), Math.pow(101, this.exp));
            return Math.pow(t, 1 / this.exp)
        }
        _beautifyVal()
        {
            const t = Math.abs(this.min - this.max);
            return t > 10 || this.integer ? this.value.toFixed(0) : t > 1 && 1 === this.exp ? this.value.toFixed(1) : this.value.toFixed(2)
        }
        _getStep()
        {
            const t = Math.abs(this.min - this.max);
            return t > 10 || this.integer ? 1 : t > 1 && 1 === this.exp ? .1 : .01
        }
        sync(t)
        {
            const e = this.attribute;
            void 0 !== t[e].value ? this.value = Math.clamp(t[e].value, this.min, this.max) : this.value = Math.clamp(t[e], this.min, this.max)
        }
        set(t)
        {
            const e = this.attribute;
            isFinite(this.value) && (void 0 !== t[e].value ? t[e].value !== this.value && (t[e].value = this.value) : t[e] !== this.value && (t[e] = this.value))
        }
        updated(t)
        {
            super.updated(t), t.has("value") && (this.dispatchEvent(new CustomEvent("change", {
                composed: !0,
                detail: this.value,
                bubbles: !0
            })), this.attribute && this.dispatchEvent(new CustomEvent(this.attribute, {
        ...
        render()
        {
            ...
            let e = t - 1,
                n = 0;
            return "center" === this.anchor && (n = 50 - Math.max(50 - e, 0), e = Math.abs(50 - e)), i.b`
			<style>
				${

            N.a}
			</style>
			<div id="container" @keydown=${

            t => "Backspace" === t.key && void 0 !== this.default ? this.value = this.default : ""}>
				<label ?hidden=${
            this.bare} for="value">${this.label}</label>
				<span ?hidden=${
            this.bare} id="units">${this.units}</span>
				<input ?hidden=${
            this.bare} name="value" type="number"
					@change=${
            this._numberInput.bind(this)}
					.min=${
            this.min}
					.max=${
            this.max}
            ...
            t => this._logValue(parseFloat(t.target.value))}
						min="1"
						max="101"
						.step=${


            Math.pow(this.step, 1 / this.exp)}
						@focus=${
            () => this.shadowRoot.querySelector("#circle").classList.add("focus")}
						@blur=${
            () => this.shadowRoot.querySelector("#circle").classList.remove("focus")}
						.value=${
            t}>
					<div id="line">
						<div id="anchor" class=${

            this.anchor} style="width:${e.toString()}%; left:${n.toString()}%"></div>
					</div>
					<div id="circle" style="left: calc(${

            (t - 1).toString()}% - ${(12 * (t - 1) / 100).toString()}px);"></div>
				</div>
			</div>
		`
    ...
    customElements.define("tone-oscilloscope", class  extends i.a{
        ...
        bind(t)
        {
            t.connect(this._waveform), this._canvas = this.shadowRoot.querySelector("canvas"), this._canvas.width = 2 * this._canvas.clientWidth, this._canvas.height = 2 * this._canvas.clientHeight, this._context = this._canvas.getContext("2d"), this.loop(), window.addEventListener("resize", () => {this._canvas.width = 2 * this._canvas.clientWidth, this._canvas.height = 2 * this._canvas.clientHeight})
        }
        loop()
        {
            ...
            this._context.clearRect(0, 0, e, n), this._context.beginPath(), this._context.lineWidth = 4, t.forEach((i, o) => {
                const r = Math.scale(o, 0, t.length, 0, e),
                    s = Math.scale(i, -1, 1, 0, n);
                0 === o ? this._context.moveTo(r, s) : this._context.lineTo(r, s)
            }), this._context.lineCap = "round", this._context.strokeStyle = "white", this._context.stroke()
        }
        render()
        {
            return i.b`
    ...
    customElements.define("tone-microphone", class  extends o.a{
        static get properties()
        {
            return {
                label: {
        ...
        constructor()
        {
            super(), this.label = "Noise", this.inputs = [], this.supported = Tone.UserMedia.supported
        }
        async bind(t)
        {
            if (!this.supported)
                return;
            setInterval(() => {this.open = "started" === t.state}, 100);
            const e = this.shadowRoot.querySelector("tone-select");
            this.shadowRoot.querySelector("#mic").addEventListener("click", n => {k(), this.open ? t.close() : t.open(e.value)}), e.addEventListener("change", n => {this.open && t.open(e.value)}), this.shadowRoot.querySelector("tone-oscilloscope").bind(t), this.inputs = await Tone.UserMedia.enumerateDevices(), this.requestUpdate()
        }
        render()
        {
            return i.b`
            ...
            !this.supported}
					id="mic" aria-label="microphone" aria-checked=${
            this.open}>
					${
            this.open ? O : P}
				</button>
    ...
    customElements.define("tone-multislider", class  extends i.a{
        ...
        constructor()
        {
            super(), this.length = 32, this.value = Array.from(new Float32Array(this.length))
        }
        _scaleArray(t)
        {
            const e = Math.max(1, ...t);
            return t.slice(0, this.length).map(t => Math.clamp(Math.abs(t / e), 0, 1))
        }
        sync(t)
        {
            this._scaleArray(t[this.attribute]).toString() !== this.value && (this.value = this._scaleArray(t[this.attribute]), this.requestUpdate())
        }
        set(t)
        {
        ...
        mousedown(t)
        {
            if (t.buttons) {
                const {x: e, y: n} = this._eventToXY(t),
                    i = this.value.length;
                if (this.value[Math.floor(e * this.length)] = n, i !== this.value.length)
        ...
        render()
        {
            ...
            t.map(t => i.b`
					<span class="slider">
						<div class="fill" style="height : ${

            Math.ceil(100 * t).toString()}%"></div>
					</span>
				`
    ...
    var R = n(138),
        $ = n.n(R);
    customElements.define("tone-keyboard-note", class  extends i.a{
        static get properties()
        {
            return {
                note: {
        ...
        constructor()
        {
            super(), this.color = "#eee", this.activecolor = "white", this.active = !1, this.touchid = -1
        }
        updated(t)
        {
            if (t.has("active")) {
                const t = this.active ? "noteon" : "noteoff";
                this.active || (this.touchid = -1), this.dispatchEvent(new CustomEvent(t, {
                    detail: {
        ...
        keydown(t)
        {
            k(), t.repeat || " " !== t.key && "Enter" !== t.key || (this.active = !0)
        }
        keyup(t)
        {
        ...
        render()
        {
            ...
            this.active ? this.activecolor : this.color};">
							${
    ...
    customElements.define("tone-keyboard-octave", class  extends i.a{
        ...
        _getNoteByTouchId(t)
        {
            const e = Array.from(this.shadowRoot.querySelectorAll("tone-keyboard-note")).find(e => e.touchid === t);
            if (e && e.note)
                return e
        }
        render()
        {
            ...
            e.map(t => i.b`
					<tone-keyboard-note color="#aaa" note="${
            t.toString()}"></tone-keyboard-note>
				`
            )}
				</div>
				<div id="black-notes">
            ...
            n.map(t => i.b`
					<tone-keyboard-note color="black" note="${
            t.toString()}"></tone-keyboard-note>
				`
            )}
				</div>
    ...
    customElements.define("tone-keyboard", class  extends i.a{
        ...
        constructor()
        {
            super(), this.rootoctave = 4, this.octaves = 4, this.polyphonic = !1, this._computerKeyboard = new $.a({
                polyphony: 1 / 0
            }), this._computerKeyboard.down(t => {k(), this.noteon(t.note)}), this._computerKeyboard.up(t => {this.noteoff(t.note)})
        }
        _getNoteByTouchId(t)
        {
            const e = Array.from(this.shadowRoot.querySelectorAll("tone-keyboard-octave")).find(e => e._getNoteByTouchId(t));
            if (e)
                return e._getNoteByTouchId(t)
        }
        _touchmove(t)
        {
            Array.from(t.changedTouches).forEach(t => {
                ...
                if (n && n.shadowRoot) {
                    ...
                    i && i.note && e.note !== i.note && (e.active = !1, e.touchid = -1, i.active = !0, i.touchid = t.identifier)
                }
            })
        }
        _touchend(t)
        ...
        render()
        {
            ...
            this._touchend.bind(this)}>
				${
            t.map(t => i.b`
					<tone-keyboard-octave octave=${
            t.toString()}></tone-keyboard-octave>
				`
            )}
			</div>
		`
    ...
    var F = n(38),
        z = n.n(F);
    customElements.define("tone-midi-in", class  extends i.a{
        constructor()
        {
            super(), z.a.enable(t => {t && error(t), z.a.addListener("connected", t => {"input" === t.port.type && this.requestUpdate()}), z.a.addListener("disconnected", t => {this.requestUpdate()})})
        }
        _flash()
        {
            clearTimeout(this._flashTimeout);
            const t = this.shadowRoot.querySelector("#light");
            t.classList.add("flash"), this._flashTimeout = setTimeout(() => t.classList.remove("flash"), 100)
        }
        _connectMidi(t)
        {
            if ("none" === t.target.value)
                return void this.shadowRoot.querySelector("#light").classList.remove("connected");
            ...
            e.addListener("noteon", "all", t => {
                const e = `${t.note.name}${t.note.octave}`,
                    n = t.note.number;
                this._flash(), this.dispatchEvent(new CustomEvent("noteon", {
                    detail: {
                        name: e,
                        midi: n,
                        velocity: t.velocity
                ...
                const e = `${t.note.name}${t.note.octave}`,
                    n = t.note.number;
                this._flash(), this.dispatchEvent(new CustomEvent("noteoff", {
                    detail: {
                        name: e,
                        midi: n,
                        velocity: t.velocity
            ...
            }), e.addListener("controlchange", "all", t => {this._flash()})
        }
        render()
        {
    ...
    customElements.define("tone-piano", class  extends i.a{
        ...
        bind(t)
        {
            this.addEventListener("noteon", e => {t.triggerAttack(e.detail.name)}), this.addEventListener("noteoff", e => {this.polyphonic ? t.triggerRelease(e.detail.name) : t.triggerRelease()})
        }
        firstUpdated()
        {
            super.firstUpdated();
            const t = this.shadowRoot.querySelector("tone-keyboard");
            this.shadowRoot.querySelector("tone-midi-in").addEventListener("noteon", e => {e.stopPropagation(), t.noteon(e.detail.midi)}), this.shadowRoot.querySelector("tone-midi-in").addEventListener("noteoff", e => {e.stopPropagation(), t.noteoff(e.detail.midi)}), window.addEventListener("resize", this._resize.bind(this)), setTimeout(() => this._resize(), 100)
        }
        _resize()
        {
            ...
            this.shadowRoot.querySelector("tone-keyboard").setAttribute("rootoctave", n), this.shadowRoot.querySelector("tone-keyboard").setAttribute("octaves", e)
        }
        render()
        {
            return i.b`
    ...
    customElements.define("tone-trigger", class  extends i.a{
        ...
        updated(t)
        {
            t.has("triggered") && this.dispatchEvent(new CustomEvent("change", {
        ...
        bind(t)
        {
            this.addEventListener("change", e => {e.detail ? t.start() : t.stop()})
        }
        _mousedown(t)
        {
            k(), "touchstart" === t.type && t.preventDefault(), this.triggered = !0
        }
        _keydown(t)
        {
        ...
        render()
        {
            ...
            () => this.triggered = !1}
					@touchend=${
            () => this.triggered = !1}
					aria-label="Trigger" .aria-checked=${
            this.triggered}>
					<div id="ring">
						<div id="circle"></div>
					</div>
    ...
    customElements.define("tone-step-sequencer", class  extends i.a{
        ...
        constructor()
        {
            super(), this.rows = 4, this.columns = 16, this.highlight = -1, this.values = [], this.adding = !1
        }
        get currentColumn()
        {
        ...
        _mousedown(t, e, n)
        {
            t.cancelable && t.preventDefault(), this.adding = !this.values[e][n], this.values[e][n] = this.adding, this.requestUpdate()
        }
        _mousemove(t, e, n)
        {
            if (t.cancelable && t.preventDefault(), t.buttons)
                ...
                const {clientWidth: i, clientHeight: o} = this.shadowRoot.querySelector("#container"),
                    {top: r, left: s} = this.getBoundingClientRect();
                Array.from(t.changedTouches).forEach(t => {
                    const a = (t.clientX - s) / i,
                        l = (t.clientY - r) / o;
                    e = Math.floor(a * this.columns), n = Math.floor(l * this.rows), this.values[e][n] = this.adding
                }), this.requestUpdate()
            }
        }
        updated(t)
        ...
        render()
        {
            ...
            this.values.map((t, e) => i.b`
					<div class="column ${
            e === this.highlight ? "highlight" : ""}">
						${
            t.map((t, n) => i.b`
							<div
								@mousemove=${

            t => this._mousemove(t, e, n)}
								@touchmove=${
            t => this._mousemove(t, e, n)}
								@mousedown=${
            t => this._mousedown(t, e, n)}
								@touchstart=${
            t => this._mousedown(t, e, n)}
								@touchend=${
            () => this.adding = !1}
    ...
    customElements.define("tone-position", class  extends i.a{
        ...
        constructor()
        {
            super(), this.position = 0, this.min = 0, this.max = 1, this._dragging = !1
        }
        bind(t)
        {
        ...
        loop(t)
        {
            requestAnimationFrame(this.loop.bind(this, t)), this._dragging || (this.position = t.progress)
        }
        _change(t)
        {
            if (this._dragging = !0, clearTimeout(this._dragTimeout), this._dragTimeout = setTimeout(() => this._dragging = !1, 200), this.tone) {
                const e = Math.scale(t.detail, this.min, this.max, 0, this.tone.loopEnd);
    ...
    customElements.define("tone-slider-2d", class  extends i.a{
        ...
        _getXY(t)
        {
            ...
            const {clientWidth: e, clientHeight: n} = this.shadowRoot.querySelector("#container");
            let i = t.offsetX,
                o = t.offsetY;
            if (t.changedTouches) {
                const {top: e, left: n} = this.getBoundingClientRect();
                i = t.changedTouches[0].clientX - n, o = t.changedTouches[0].clientY - e
            }
            return {
        ...
        _mousedown(t)
        {
            ...
            this.x = e, this.y = n, this.dispatchEvent(new CustomEvent("mousedown", {
                detail: {
                    x: this.x,
                    y: this.y
                },
        ...
        {
            const {x: e, y: n} = this._getXY(t);
            this.x = e, this.y = n, this.dispatchEvent(new CustomEvent("mouseup", {
                detail: {
                    x: this.x,
                    y: this.y
                },
        ...
        _mousemove(t)
        {
            if (t.buttons || t.changedTouches) {
                const {x: e, y: n} = this._getXY(t);
                this.x = e, this.y = n, this.dispatchEvent(new CustomEvent("change", {
                    detail: {
                        x: this.x,
                        y: this.y
                    },
        ...
        render()
        {
            ...
            this._mouseleave.bind(this)}>
				<div id="circle" style="left : ${
            (100 * this.x).toString()}% ; top : ${(100 * (1 - this.y)).toString()}%">
				</div>
			</div>
		`
    ...
    var D = n(50);
    customElements.define("tone-envelope-viz", class  extends D.a{
        constructor()
        {
            super(), this.min = 0, this.max = 1.1, this.duration = .1, this.alt = "envelope curve"
        }
        async visualize(t)
        {
            const e = t.get(),
                ...
                i = await Tone.Offline(() => {
                    ...
                    t.set(e), t.attack *= 1, t.decay *= 1, t.release *= 1, t.toMaster(), t.triggerAttack(.001), t.triggerRelease(1 * (e.attack + e.decay + .01) + .001)
                }, 1 * (n + .01) + .002);
            this.buffer = i.toArray(0), this.requestUpdate()
        }
    }
    ...
    customElements.define("tone-frequency-envelope", class  extends L{
        renderAttributes()
        {
            return i.b`
			<tone-slider
    ...
    customElements.define("tone-meter", class  extends i.a{
        ...
        bind(t)
        {
            if (this.stereo, this.stereo) {
                ...
                t.connect(e), this._meters = [new Tone.Meter(.9), new Tone.Meter(.9)], e.left.connect(this._meters[0]), e.right.connect(this._meters[1])
            } else
                this._meters = [new Tone.Meter(.9)], t.connect(this._meters[0]);
            this._canvas = this.shadowRoot.querySelector("canvas"), this._canvas.width = 2 * this._canvas.clientWidth, this._canvas.height = 2 * this._canvas.clientHeight, this._context = this._canvas.getContext("2d"), this.loop(), window.addEventListener("resize", () => {this._canvas.width = 2 * this._canvas.clientWidth, this._canvas.height = 2 * this._canvas.clientHeight})
        }
        loop()
        {
            requestAnimationFrame(this.loop.bind(this));
            ...
            i.forEach((t, n) => {this._context.fillRect(n * o + r * n, e - t, o - r, t)}), this.level && Array.from(this.shadowRoot.querySelectorAll(".level")).forEach((t, e) => {
                let i = n[e];
        ...
        {
            let t = i.b``;
            return this.level && (t = this.stereo ? i.b`
            ...
            this.level ? i.b`
					<div id="level" style="color:${
            this.color}">${t}</div>` : i.b``}
			</div>
		`
    ...
    var q = n(139),
        j = n.n(q);
    customElements.define("tone-presets", class  extends i.a{
        static get properties()
        {
            return {
                label: {
        ...
        constructor()
        {
            super(), this.label = "Presets", this.presets = JSON.stringify("[]"), this._options = {}
        }
        bind(t)
        {
            this.addEventListener("preset", e => {
                ...
                t.set(o), this.dispatchEvent(new CustomEvent("sync", {
                    detail: o,
                    composed: !0,
                    bubbles: !0
                }))
        ...
        _clicked(t, e)
        {
            ...
            this.dispatchEvent(new CustomEvent("preset", {
                detail: n,
                composed: !0,
                bubbles: !0
            }))
    ...
    class H extends o.a {
        ...
        bind(t)
        {
            ...
            e && e.bind(t), this.polyphonic ? t.voices.forEach(t => super.bind(t)) : super.bind(t)
        }
        renderAttributes()
        {
            return i.b``
    ...
    customElements.define("tone-synth", class  extends H{
        constructor()
        {
    ...
    customElements.define("tone-mono-synth", class  extends H{
        constructor()
        {
            super(), this.label = "MonoSynth", this.presets = JSON.stringify(B)
        }
        renderAttributes()
        {
            return i.b`
    ...
    const G = [{
        ...
        frequency: 300,
        envelope: {
            attack: .09584313725490196,
            decay: .26265196078431374,
            sustain: 0,
            release: .4888,
            attackCurve: "ripple",
            decayCurve: "exponential",
    ...
    customElements.define("tone-metal-synth", class  extends H{
        constructor()
        {
            super(), this.label = "MetalSynth", this.presets = JSON.stringify(G)
        }
        renderAttributes()
        {
            return i.b`
    ...
    const U = [{
        pitchDecay: .0033411764705882354,
        octaves: .8300000000000001,
        oscillator: {
            frequency: 440,
            detune: 0,
            phase: 0,
    ...
    customElements.define("tone-membrane-synth", class  extends H{
        constructor()
        {
            super(), this.label = "MembraneSynth", this.presets = JSON.stringify(U)
        }
        renderAttributes()
        {
            return i.b`
    ...
    const W = [{
        ...
        envelope: {
            attack: .012926470588235294,
            decay: .05975,
            sustain: .16,
            release: .18211764705882355,
            attackCurve: "exponential",
            decayCurve: "exponential",
            releaseCurve: "exponential"
        },
        ...
        envelope: {
            attack: .010585294117647059,
            decay: .27689411764705885,
            sustain: 0,
            release: .7328941176470589,
            attackCurve: "linear",
            decayCurve: "exponential",
            releaseCurve: "exponential"
        },
        ...
        modulationEnvelope: {
            attack: .0427764705882353,
            decay: .8596519607843138,
            sustain: .08,
    ...
    customElements.define("tone-am-synth", class  extends H{
        constructor()
        {
    ...
    customElements.define("tone-filter-viz", class  extends D.a{
        constructor()
        {
            super(), this.min = 0, this.max = 2.5, this.alt = "filter response curve"
        }
        drawBackground(t, e, n)
        {
            t.fillStyle = "rgba(255, 255, 255, 0.3)", t.fillRect(0, .6 * n, e, 3), t.fill()
        }
        async visualize(t)
        {
            this.buffer = t.getFrequencyResponse().map(t => Math.pow(t, .5)), this.requestUpdate()
        }
    }
    );
    ...
    customElements.define("tone-volume-slider", class  extends i.a{
        ...
        render()
        {
            ...
            this.value}"
						@change=${
            t => this.value = t.detail}
						bare></tone-slider>
				</div>
				<div id="number">${


            this.value >= 0 ? "+" : ""}${this.value.toFixed(0)} db</div>
			</div>
		`
    ...
    customElements.define("tone-channel", class  extends o.a{
        ...
        bind(t)
        {
            this.shadowRoot.querySelector("tone-meter").bind(t), this.addEventListener("mute", e => {t.mute = e.detail}), this.addEventListener("solo", e => {t.solo = e.detail}), setInterval(() => {this.muted = t.muted}, 100), super.bind(t)
        }
        updated(t)
        {
            super.updated(t), t.has("solo") && this.dispatchEvent(new CustomEvent("solo", {
                detail: this.solo,
                composed: !0,
                bubbles: !0
            })), t.has("mute") && this.dispatchEvent(new CustomEvent("mute", {
                detail: this.mute,
                composed: !0,
                bubbles: !0
            }))
        ...
        render()
        {
            ...
            this.solo}
						@click=${
            t => this.solo = !this.solo}
						class=${
            this.solo ? "enabled" : ""}>
						solo</button>
					<button id="mute" aria-checked=${
    ...
    customElements.define("tone-transport", class  extends o.a{
        ...
        bind(t)
        {
            super.bind(t), this.shadowRoot.querySelector("tone-play-toggle").bind(t), setInterval(() => {this.shadowRoot.querySelector("#position").textContent = t.position}, 100)
        }
        render()
        {
            return i.b`
            ...
            this.controls ? i.b`
					<tone-rack square label="Transport Settings" ?collapsed=${
            this.collapsed}>
						<tone-toggle
							label="Loop"
							attribute="loop">
    ...
    customElements.define("tone-unmute", class  extends o.a{
        ...
        constructor()
        {
            super(), this.suspended = !0, this.muted = !1, this.focused = !1, setInterval(() => {this.suspended = "suspended" === Tone.context.state}, 100)
        }
        updated(t)
        {
            if (t.has("muted")) {
        ...
        _adjustVolume(t)
        {
            t.detail === t.target.min ? this.muted = !0 : this.muted = !1, Tone.Master.volume.value = t.detail
        }
        render()
        {
            return i.b`
            ...
            this.focused} ?novolume=${this.novolume}>
				<button
					@blur=${
            ...
            t => this.focused = !0}
					@click=${
            this._clicked.bind(this)}
					id="speaker" aria-label="speaker" aria-checked=${
            this.suspended}>
					${
    ...
    customElements.define("tone-top-bar", class  extends i.a{
        ...
        updated()
        {
            ...
            const {width: e, height: n} = t,
                ...
                o = function(t) {
                    const e = new Array(t),
                        ...
                        r = [e, i, o, n];
                    for (let n = 0; n < t; n++)
                        e[n] = Math.sin(2 * Math.PI * n / t);
                    for (let e = 0; e < t; e++)
                        i[e] = (e + t / 2) % t / t * 2 - 1;
                    for (let e = 0; e < t; e++)
                        o[e] = e < t / 3 ? e / (t / 3) * 2 - 1 : e < 2 * t / 3 ? 2 * (1 - (e - t / 3) / (t / 3)) - 1 : (e - 2 * t / 3) / (t / 3) * 2 - 1;
                    for (let e = 0; e < t; e++) {
                        const i = t / 16;
            ...
            i.beginPath(), o.forEach((t, e) => {
                const o = Math.scale(t, -1, 1, .25 * n, .75 * n);
                0 === e ? i.moveTo(e, o) : i.lineTo(e, o)
            }), i.lineTo(e, n), i.lineTo(0, n), i.fillStyle = "#22DBC0", i.fill()
        }
        render()
        {
            return i.b`
    ...
    customElements.define("tone-drawer", class  extends i.a{
        static get properties()
        {
            return {
                collapsed: {
        ...
        constructor()
        {
            super(), this.collapsed = window.innerHeight < 700, this.label = "Components"
        }
        updated(t)
        {
            if (t.has("collapsed") && !this.collapsed) {
                const t = t => {t.dispatchEvent(new CustomEvent("collapse", {
                        detail: this.collapsed,
                        composed: !0,
                        bubbles: !0
                    }))};
                Array.from(this.children).forEach(e => {e.assignedNodes ? Array.from(e.assignedNodes()).forEach(e => t(e)) : t(e), e.dispatchEvent(new CustomEvent("collapse", {
                        detail: this.collapsed,
                        composed: !0,
                        bubbles: !0
    ...
    customElements.define("tone-loader", class  extends i.a{
        ...
        constructor()
        {
            super(), this.progress = 0, this.loaded = !1, Tone.Buffer.on("progress", t => {this.progress = t}), Tone.loaded().then(() => {this.loaded = !0, setTimeout(() => {this.remove()}, 500)})
        }
        render()
        {
            return i.b`
            ...
            (100 * this.progress).toString()}%"></div>
				</div>-->
			</div>
		`
    ...
    customElements.define("tone-side-panel", class  extends i.a{
        static get properties()
        {
            return {
                collapsed: {
        ...
        constructor()
        {
            super(), this.collapsed = !0, this.examples = {}, this.fetchExamples()
        }
        async fetchExamples()
        {
            try {
        ...
        updated(t)
        {
            t.has("collapsed") && this.dispatchEvent(new CustomEvent("collapse", {
                detail: this.collapsed,
                composed: !0
            }))
        }
    ...
    customElements.define("tone-waveform", class  extends i.a{
        constructor()
        {
            super(), this._waveform = function(t) {
                const e = new Array(t),
                    n = new Array(t),
                    i = new Array(t),
                    o = new Array(t),
            ...
            }(512).random, this._analyser = new Tone.Waveform(512), this._signal = (new Tone.Zero).connect(this._analyser), this._silentThresh = .001, this._rms = 0
        }
        firstUpdated()
        {
        ...
        _loop()
        {
            ...
            this._isSilent(i) ? this._drawAnalysis(this._waveform, !0, n) : this._drawAnalysis(i, !1, n)
        }
        _isSilent(t)
        {
            let e = 0;
            ...
            return this._rms = Math.max(n, .9 * this._rms), this._rms < this._silentThresh
        }
        _drawAnalysis(t, e, n)
        {
            ...
            let r,
                s = .2 * o;
            e && (s = Math.scale(this._rms, 0, this._silentThresh, .2 * o, .5 * o)), n.clearRect(0, 0, i, o), n.beginPath();
    ...
    customElements.define("tone-start-context", class  extends i.a{
        static get properties()
        {
            return {
                running: {
        ...
        firstUpdated()
        {
            const t = setInterval(() => {this.running = "running" === Tone.context.state, this.running && clearInterval(t)}, 100)
        }
        async _clicked(t)
        {
    ...
    customElements.define("tone-demo", class  extends i.a{
        ...
        firstUpdated()
        {
            super.firstUpdated(), this.shadowRoot.querySelector("tone-waveform").bind(Tone.Master)
        }
        render()
        {
            return i.b`
    ...
    customElements.define("tone-fft", class  extends i.a{
        ...
        bind(t)
        {
            t.connect(this._fft), this._canvas = this.shadowRoot.querySelector("canvas"), this._canvas.width = 2 * this._canvas.clientWidth, this._canvas.height = 2 * this._canvas.clientHeight, this._context = this._canvas.getContext("2d"), this.loop(), window.addEventListener("resize", () => {this._canvas.width = 2 * this._canvas.clientWidth, this._canvas.height = 2 * this._canvas.clientHeight})
        }
        loop()
        {
            requestAnimationFrame(this.loop.bind(this));
            const t = this._fft.getValue(),
                e = this._canvas.width,
                n = this._canvas.height;
            this._context.clearRect(0, 0, e, n), this._context.fillStyle = "white", t.forEach((i, o) => {
                const r = Math.scale(o, 0, t.length, 0, e),
                    s = Math.clamp(Math.scale(i, -100, 0, 0, n), 0, n);
                this._context.fillRect(r, n / 2 - s / 2, 2, s), this._context.fill()
            })
        }
        render()
        {
    ...
    customElements.define("tone-loop", class  extends i.a{
        ...
        bind(t)
        {
            this._canvas = this.shadowRoot.querySelector("canvas"), this._canvas.width = 2 * this._canvas.clientWidth, this._canvas.height = 2 * this._canvas.clientHeight, this._context = this._canvas.getContext("2d"), this.loop(t), window.addEventListener("resize", () => {this._canvas.width = 2 * this._canvas.clientWidth, this._canvas.height = 2 * this._canvas.clientHeight})
        }
        loop(t)
        {
    ...
    customElements.define("tone-chorus", class  extends nt{
        constructor()
        {
    ...
    customElements.define("tone-reverb", class  extends nt{
        ...
        bind(t)
        {
            ...
            let e = -1;
            this.addEventListener("change", () => {this.generating = !0, clearTimeout(e), e = setTimeout(() => {this.generate(t)}, 100)})
        }
        async generate(t)
        {
